...
public class VentaREST {
    ...
    public Response crearVenta(VentaInput ventaInput) {
        try {
            ...
            //Validar que los productos existen y tienen suficiente stock
            for (DetalleVentaInput detalleInput : ventaInput.getDetalles()) {
                ...
                if (producto.getCantidadExistente() < detalleInput.getCantidad()) {
                    return Response.status(Response.Status.BAD_REQUEST)
                            .entity("No hay suficiente stock para el producto con ID " + detalleInput.getIdProducto())
                            .build();
                }
            }
