...
public class EmailService {
    ...
    private static final String FROM_EMAIL = "develop.ith@gmail.com";
    private static final String FROM_PASSWORD = "wtagiesqynpaeiwo"; // Use env variables in production
